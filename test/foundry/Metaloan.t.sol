...
contract ContractTest is Test {
    ...
    address constant public OWNER = address(3);
    address constant public LENDER = address(4);
    ...
    vm.startPrank(OWNER);
        ...
        console2.log("Balance if the owner when minting",ERC20USDT.balanceOf(OWNER));
    ...
    function test_createPlan() public {
        vm.startPrank(OWNER);
            ...
            metaloan.createPlan(address(LENDER),
                                address(ERC20USDT)
                                , _upfrontPayment
                                , _monthlyPayment);
        ...
        (address lender, , 
                 ...
                 uint256 monthlyPayment) = metaloan.idToPlan(0);
    ...
    function test_requestLoan() public {
        ...
        (address lender,
             address tokenPayment,,) = metaloan.idToPlan(0);
        
        console2.log("TokenPayment", tokenPayment);
        uint256 lenderBalanceBefore = IERC20(tokenPayment).balanceOf(address(lender));
        ...
        uint256 lenderBalanceAfter = IERC20(tokenPayment).balanceOf(address(lender));
