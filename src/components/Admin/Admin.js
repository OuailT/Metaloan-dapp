...
const Admin = ({alert, 
    ...
    const createloanPlan = (e) => {
        ...
        if(!lenderAddress || !USDTaddress || !downtPayment || !monthlyPayment ) {
          ...
          setActivePayment(false);
            ...
            console.log(lenderAddress, downtPaymentFormated, USDTaddress, monthlyPaymentFormated);
            blockchain.smartContract.methods.createPlan(lenderAddress, USDTaddress, downtPaymentFormated, monthlyPaymentFormated)
    ...
    return (
        ...
        <form class="book-form" onSubmit={createloanPlan}>
