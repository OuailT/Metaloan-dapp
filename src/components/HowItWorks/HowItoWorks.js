            ...
            <div className="howItWorks-content" id="howitworks" data-scroll-section>
                ...
                <div className="textBox">
                    ...
                    <ul className="requestLoan_list" >
                        ...
                        <li id="hero-text">2. MetaLoan will review your inquiry and get back to you with a loan plan.</li>
                        <li id="hero-text">3. You provide requested documentation and the down payment.</li>
                        <li id="hero-text">4. MetaLoan purchases the metaverse land you’re interested in and gives you full use rights.</li>
                        <li id="hero-text">5. You make secure payments via MetaLoan’s decentralized application, which provides you with accurate and verifiable transaction history on the blockchain.</li>
                        <li id="hero-text">6. After you complete your monthly payments, MetaLoan sends the metaverse land to your wallet.</li>
                    </ul>
                    <div id="hero-text">
